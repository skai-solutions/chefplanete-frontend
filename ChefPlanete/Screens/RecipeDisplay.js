...
const RecipeDisplay = ({navigation, onSubmit}) => {
  ...
  const html = '<div style="font-family:verdana;font-size: 300%; color: darkgreen;">' + summary + '</div>';
    ...
    <Container style={styles.container}>
      ...
      <ScrollView>
        <Content style={styles.dashboard}>
          ...
          />
          <View>
          <Text style={styles.text}>{recipeTitle}</Text>
          </View>
          <Tabs>
            ...
            <Tab heading={<TabHeading><Text>Instruction</Text></TabHeading>}>
              {/*<Text>{JSON.stringify(instructions[0].steps)}</Text>*/}
              <List>
                {
